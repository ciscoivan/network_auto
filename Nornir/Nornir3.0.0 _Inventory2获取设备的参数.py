...
print (nr.inventory.hosts['ro1'].name)
print (nr.inventory.hosts['ro1'].hostname)
print (nr.inventory.hosts['ro1'].username)
print (nr.inventory.hosts['ro1'].password)
print (nr.inventory.hosts['ro1'].platform)
print (nr.inventory.hosts['ro1'].groups)
print (nr.inventory.hosts['ro1'].data)
